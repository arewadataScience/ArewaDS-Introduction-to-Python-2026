...
| Title | Resource | Recording | Office Hours |
| --- | --- | --- | --- |
| Initial Setup | [macOS](https://github.com/arewadataScience/python-programming-fellowship/blob/main/00_Stage-1-Getting-Started/macOS.md) \| [Windows](https://github.com/arewadataScience/python-programming-fellowship/blob/main/00_Stage-1-Getting-Started/WINDOWS.md) \| [Linux](https://github.com/arewadataScience/python-programming-fellowship/blob/main/00_Stage-1-Getting-Started/LINUX.md#set-up-instructions-for-linux) | [Tutorial](https://www.youtube.com/watch?v=bRW5r7TK6KM) | [Office Hours](#) |
| Basic Command Line Operations | [Command Line](https://github.com/arewadataScience/python-programming-fellowship/blob/main/00_Stage-1-Getting-Started/commandline.md) | [Recording](https://youtu.be/VgiP2-pHF3Y) | [Office Hours](#) |
| Setup Git and GitHub | [Git / GitHub](https://github.com/arewadataScience/python-programming-fellowship/blob/main/00_Stage-1-Getting-Started/github.md) | [Recording](https://www.youtube.com/watch?v=FN4J5wHK898) | [Office Hours](#) |
| Python Virtual Environments | [Virtual Environment](https://github.com/arewadataScience/python-programming-fellowship/blob/main/00_Stage-1-Getting-Started/python-venv.md) | [Recording](https://youtu.be/iszkG8QSPng) | [Office Hours](#) |
| VSCode for Python | [VSCode Setup](https://github.com/arewadataScience/python-programming-fellowship/blob/main/00_Stage-1-Getting-Started/vscode.md) | [Recording](https://www.youtube.com/watch?v=pmUkRRqtpEY) | [Office Hours](#) |
| Introduction to Markdown | [Markdown](https://github.com/arewadataScience/python-programming-fellowship/blob/main/00_Stage-1-Getting-Started/markdown.md) | [Recording](https://www.youtube.com/watch?v=oNwEag0eqwE) | [Office Hours](#) |
| Google Colab | [Google Colab](#) | [Recording](https://youtu.be/3P5PgSzHPmI) | [Office Hours](#) |
